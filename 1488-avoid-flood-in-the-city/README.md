<h2><a href="https://leetcode.com/problems/avoid-flood-in-the-city/editorial/?envType=daily-question&envId=2025-10-07">1488. Avoid Flood in The City</a></h2><h3>Medium</h3><hr><p>Your country has an infinite number of lakes. Initially, all the lakes are empty, but when it rains over the <code>nth</code> lake, the <code>nth</code> lake becomes full of water. If it rains over a lake that is <strong>full of water</strong>, there will be a <strong>flood</strong>. Your goal is to avoid floods in any lake.</p>
